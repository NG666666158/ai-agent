...
ALLOWED_TASK_TRANSITIONS: dict[TaskStatus, set[TaskStatus]] = {
    ...
    TaskStatus.WAITING_TOOL: {TaskStatus.RUNNING, TaskStatus.FAILED, TaskStatus.CANCELLED},
    TaskStatus.REFLECTING: {TaskStatus.COMPLETED, TaskStatus.FAILED, TaskStatus.CANCELLED},
